...
struct ResTable_config
{
  ...
  enum {
    ...
    enum {
        ...
        // uiMode bits for the alliance switch.
        MASK_UI_MODE_ALLIANCE = 0x30,
        SHIFT_UI_MODE_ALLIANCE = 4,
        UI_MODE_ALLIANCE_ANY = ACONFIGURATION_UI_MODE_ALLIANCE_ANY << SHIFT_UI_MODE_ALLIANCE,
        UI_MODE_ALLIANCE_NO = ACONFIGURATION_UI_MODE_ALLIANCE_NO << SHIFT_UI_MODE_ALLIANCE,
        UI_MODE_ALLIANCE_YES = ACONFIGURATION_UI_MODE_ALLIANCE_YES << SHIFT_UI_MODE_ALLIANCE,
    };
