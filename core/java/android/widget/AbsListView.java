/*
 * Copyright (C) 2006 The Android Open Source Project, 2016 AllianceROM
 *
    ...
    void reportScrollStateChange(int newState) {
        if (newState != mLastScrollState) {
            ...
            if (newState == OnScrollListener.SCROLL_STATE_IDLE) {
                ...
                mListAnimationMode = Settings.System.getIntForUser(mContext.getContentResolver(),
                        Settings.System.ANIMATION_LISTVIEW, 0, UserHandle.USER_CURRENT_OR_SELF);
                if (mListAnimationMode != 0) {
                    mListAnimationInterpolatorMode = Settings.System.getIntForUser(mContext.getContentResolver(),
                            Settings.System.ANIMATION_LISTVIEW_INTERPOLATOR, 0, UserHandle.USER_CURRENT_OR_SELF);
                }
            }
            if (mOnScrollListener != null) {
