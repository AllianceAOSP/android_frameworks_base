...
import com.android.internal.statusbar.ICMStatusBarManager;
import com.android.internal.statusbar.ICustomTileListener;
import com.android.internal.statusbar.IStatusBarCustomTileHolder;
...
public class CustomTileListenerService extends Service {
    ...
    public static final String SERVICE_INTERFACE
            = "com.android.internal.statusbar.CustomTileListenerService";
    ...
    private final ICMStatusBarManager getStatusBarInterface() {
        if (mStatusBarService == null) {
            mStatusBarService = ICMStatusBarManager.Stub.asInterface(
                    ServiceManager.getService(AllianceContextConstants.ALLIANCE_STATUS_BAR_SERVICE));
        }
