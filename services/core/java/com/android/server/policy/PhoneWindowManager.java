...
import com.android.internal.util.ActionUtils;
...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    boolean mNavigationBarLeftInLandscape = false; // is the navigation bar left handed?
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                            Settings.System.WAKE_WITH_VOLUME_KEYS), false, this,
                    UserHandle.USER_ALL);
            updateSettings();
        }
    ...
    private EdgeGestureManager.EdgeGestureActivationListener mEdgeGestureActivationListener
        ...
        public void onEdgeGestureActivation(int touchX, int touchY,
            ...
            } else if (position == EdgeGesturePosition.LEFT && !mNavigationBarOnBottom && mNavigationBarLeftInLandscape) {
                target = mNavigationBar;
    ...
    public void init(Context context, IWindowManager windowManager,
        ...
        if (!deviceKeyHandlerLib.isEmpty() && !deviceKeyHandlerClass.isEmpty()) {
            ...
            try {
                ...
                Slog.w(TAG, "Could not instantiate device key handler " + deviceKeyHandlerClass + " from class "
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            setHasNavigationBar();
            mNavigationBarHeight = Settings.System.getIntForUser(mContext.getContentResolver(),
            ...
            if (mNavigationBarHeight == -2) {
                ...
                mNavigationBarHeight = AllianceUtils.dpToPx(mContext, mNavigationBarHeight);
            }

            mNavigationBarHeightLandscape = Settings.System.getIntForUser(mContext.getContentResolver(),
            ...
            mVolumeKeysWake = (Settings.System.getIntForUser(resolver,
                    Settings.System.WAKE_WITH_VOLUME_KEYS, 0, UserHandle.USER_CURRENT) == 1);
        }
    ...
    public int selectAnimationLw(WindowState win, int transit) {
        ...
        if (win == mStatusBar) {
            ...
            // This can be on either the bottom, the left, or the right.
            if (mNavigationBarOnBottom) {
                if (transit == TRANSIT_EXIT
                        || transit == TRANSIT_HIDE) {
                ...
                if (transit == TRANSIT_EXIT
                    ...
                    return mNavigationBarLeftInLandscape ? R.anim.dock_left_exit : R.anim.dock_right_exit;
                        ...
                        || transit == TRANSIT_SHOW) {
                    return mNavigationBarLeftInLandscape ? R.anim.dock_left_enter : R.anim.dock_right_enter;
                }
            }
        }
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
...

        {
            final KeyCharacterMap kcm = event.getKeyCharacterMap();
            if (kcm.isPrintingKey(keyCode)) {
                Intent shortcutIntent = mShortcutManager.getIntent(kcm, keyCode, metaState & ~(KeyEvent.META_META_ON
        ...
        if (down && repeatCount == 0 && (keyCode == KeyEvent.KEYCODE_LANGUAGE_SWITCH
                || (keyCode == KeyEvent.KEYCODE_SPACE && (metaState & KeyEvent.META_CTRL_MASK) != 0)))
    ...
    private boolean isWakeKeyWhenScreenOff(int keyCode) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_DOWN:
            case KeyEvent.KEYCODE_VOLUME_MUTE:
                return mVolumeKeysWake || mDockMode != Intent.EXTRA_DOCK_STATE_UNDOCKED;
