...
public class Recents extends SystemUI
    ...
    class RecentsSettingsObserver extends UserContentObserver {
        ...
        protected void observe() {
            ...
            mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RECENTS_SHOW_SEARCH_BAR), false, this);
            update();
        }
    ...
    void reloadHeaderBarLayout() {
        ...
        if (mConfig.searchBarEnabled && mSystemServicesProxy.getOrBindSearchAppWidget(mContext, mAppWidgetHost) != null) {
