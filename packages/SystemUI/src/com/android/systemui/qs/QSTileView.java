...
public class QSTileView extends ViewGroup {
    ...
    public QSTileView(Context context) {
        ...
        mTextColor = Settings.System.getInt(context.getContentResolver(), Settings.System.QUICK_SETTINGS_TILE_TEXT_COLOR, Color.WHITE);
    ...
    protected void handleStateChanged(QSTile.State state) {
        ...
        if (mDual) {
            ...
            if (!Objects.equals(state.enabled, mDualLabel.isEnabled())) {
                ...
                mDualLabel.setTextColor(mContext.getResources().getColor(state.enabled ? R.color.qs_tile_text : R.color.qs_tile_text_disabled));
            }
        } else {
            ...
            if (!Objects.equals(state.enabled, mLabel.isEnabled())) {
                ...
                mLabel.setTextColor(mContext.getResources().getColor(state.enabled ? R.color.qs_tile_text : R.color.qs_tile_text_disabled));
            }
        }
    }
    ...
    protected void setIcon(ImageView iv, QSTile.State state) {
        ...
        if (!Objects.equals(state.enabled, iv.isEnabled())) {
            ...
            if (state.enabled) {
                ...
                iv.setColorFilter(Color.GRAY, Mode.MULTIPLY);
            }
        }
    }
    ...
    public void setIconColor() {
        if (mIcon instanceof ImageView) {
            updateColors();
            ImageView image = (ImageView) mIcon;
            image.setColorFilter(mIconColor, Mode.MULTIPLY);
        }
    }
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.QS_USE_FOUR_COLUMNS), false, this, UserHandle.USER_ALL);
            update();
        }
